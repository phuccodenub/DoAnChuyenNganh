...
export function EditorPage() {
  ...
  const handleCoverUpload = async (file: File | null) => {
    ...
    try {
      ...
      // Response is FileUpload type with url property
      setValue('thumbnail', (response as any).file?.url || (response as any).url || '', { shouldDirty: true });
    } catch {
  ...
  const handleVideoUpload = async (file: File | null) => {
    ...
    try {
      ...
      // Response is FileUpload type with url property
      setValue('video_intro', (response as any).file?.url || (response as any).url || '', { shouldDirty: true });
    } catch {
      // Toast handled in hook
    }
  };
